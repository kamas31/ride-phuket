...
const SRC_FULL    = path.join(ROOT, 'exports', 'Koh Ride Icon 1024.png')     // dark bg — generated by generate-all-icons.js
const SRC_IOS     = path.join(ROOT, 'exports', 'Koh Ride Icon iOS 1024.png') // orange bg — generated by generate-all-icons.js
...
async function main () {
  ...
  const px16 = await sharp(SRC_IOS).resize(16, 16).ensureAlpha().png().toBuffer()
  const px32 = await sharp(SRC_IOS).resize(32, 32).ensureAlpha().png().toBuffer()
  const ico  = buildIco([
