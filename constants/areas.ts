...
export const AREAS: AreaMeta[] = [
  {
    ...
    name: 'Patong',
    label: 'Patong Beach',
    description: 'Rent a scooter in Patong Beach, Phuket. Delivered to your hotel from ฿250/day.',
    ...
    highlights: ['Largest selection in Patong', 'Hotel delivery under 30 min', '10+ verified shops'],
  ...
  },
  {
    ...
    name: 'Kata',
    label: 'Kata Beach',
    description: 'Rent a scooter in Kata Beach, Phuket. Premium scooters from ฿250/day with hotel delivery.',
  ...
  },
  {
    ...
    description: 'Rent a scooter in Bang Tao, Phuket. Luxury area delivery from ฿250/day.',
    ...
    highlights: ['Luxury villa delivery', 'Long peaceful beach', 'North Phuket access'],
