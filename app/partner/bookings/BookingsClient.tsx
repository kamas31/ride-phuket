      ...
      <div className="bg-white border-b border-[#e8e8e4]">
        <div className="max-w-2xl mx-auto px-4 pt-20 pb-5">
          ...
          <div className="flex items-end justify-between">
            <div>
              <h1 className="text-[24px] font-bold text-[#0f0f0e] tracking-tight">Bookings</h1>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-3">
        {sorted.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="font-semibold text-[#0f0f0e] mb-1">No bookings yet</p>
            <p className="text-sm text-[#9c9c98]">
              {filter === 'all'
                ? 'Bookings will appear here once riders reserve your scooters.'
                : `No ${STATUS_CFG[filter as StatusKey]?.label.toLowerCase()} bookings.`
              }
            </p>
          </div>
        )}
